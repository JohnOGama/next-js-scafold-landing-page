      ...
      <main className="relative mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:px-8 z-10">
        ...
        <div className="text-center py-16">
          ...
          <p className="mb-10 max-w-xl mx-auto text-lg text-zinc-600 dark:text-zinc-400">
            Clone, build, and link to start scaffolding Next.js frontends — and optionally pair them with a NestJS backend.
          </p>
          <div className="flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
            ...
            <Link
              className="group flex h-12 items-center justify-center gap-2 rounded-full border-2 border-blue-500/80 dark:border-blue-400/80 bg-blue-500/90 dark:bg-blue-500/90 text-white backdrop-blur-sm px-8 font-medium transition-all duration-300 hover:scale-105 hover:border-blue-400 dark:hover:border-blue-300 hover:bg-blue-600 dark:hover:bg-blue-400 hover:shadow-lg"
              href={LINKS.nestQuickStart}
              target="_blank"
              rel="noopener noreferrer"
            >
              <span className="inline-flex h-2 w-2 rounded-full bg-emerald-300 shadow-[0_0_12px_rgba(52,211,153,0.8)]" />
              <span>Scaffold NestJS Backend</span>
            </Link>
          </div>
        </div>
